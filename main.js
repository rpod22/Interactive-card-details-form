window.onload = function() {
  ...
  cardNumberInput.addEventListener("input", function() {
    ...
    if(cardNumberInput.value == "" || cardNumberInput.value.match(/[a-zA-Z]/g) || cardNumberInput.value.length !== 19) {
  ...
  monthInput.addEventListener("input", function() {
    ...
    if(monthInput.value.match(/[a-zA-Z]/g)
    ...
    if(monthInput.value == "" || monthInput.value.match(/[a-zA-Z]/g) || monthInput.value.length < 2) {
  ...
  yearInput.addEventListener("input", function() {
    ...
    if(yearInput.value.match(/[a-zA-Z]/g)
    ...
    if(yearInput.value == "" || yearInput.value.match(/[a-zA-Z]/g) || yearInput.value.length < 2) {
  ...
  cvvNumberInput.addEventListener("input", function() {
    ...
    if(cvvNumberInput.value.match(/[a-zA-Z]/g) ||
    ...
    if(cvvNumberInput.value == "" || cvvNumberInput.value.length < 3 || cvvNumberInput.value.match(/[a-zA-Z]/g)) {
  ...
  confirmBtn.addEventListener("click", function() {
    if(cardNumberInput.classList.contains("valid") &&
